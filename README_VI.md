...
| 17 | Thống kê và Báo cáo | ![Thống kê và Báo cáo](docs/images/thongkevabaocao.png) | **Phân tích Đa chiều**: Hệ thống báo cáo chi tiết cho từng phân hệ: Người dùng, Chuyến đi, Cung đường và Nội dung. Giúp Admin nắm bắt xu hướng và hiệu quả hoạt động của toàn bộ nền tảng. |
